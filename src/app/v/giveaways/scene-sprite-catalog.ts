...
const BOARD_FRAME = staticSprite('board-frame', '/giveaways/sprites/inferno-board-bg.webp');
const BOARD_FRAME_OVERLAY = staticSprite('board-frame-overlay', '/giveaways/sprites/inferno-board-bg.webp');
